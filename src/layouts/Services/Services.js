...
export const ServicesContainer = ({ className, ...rest }) => (
  <article className={classes(styles.services, className)} {...rest} />
);
...
export const ServicesBackground = ({ opacity = 0.7, className, ...rest }) => {
...
export const ServicesImage = ({ className, alt, ...rest }) => (
  <div className={classes(styles.image, className)}>
    <Image reveal alt={alt} delay={300} {...rest} />
  </div>
);

export const ServicesSectionContent = ({ className, width = 'l', ...rest }) => (
  <div
...
export const ServicesSectionHeading = ({ className, level = 3, as = 'h2', ...rest }) => (
  <Heading
...
export const ServicesSectionText = ({ className, ...rest }) => (
  <Text className={classes(styles.sectionText, className)} size="l" as="p" {...rest} />
);

export const ServicesTextRow = ({
  center,
  stretch,
  justify = 'center',
  width = 'm',
...
export const ServicesSectionColumns = ({ className, centered, ...rest }) => (
